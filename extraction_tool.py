...
{{
  ...
  "csr_spend_previous_fy": "Extract Total CSR Spend/Expenditure for the most recent completed financial year (e.g. '₹15.20 Cr (FY24)' or '₹12.50 Cr (FY 2023-24)'). Format with currency, amount and year, or 'Not Found'",
  "csr_spend_previous_3fy": "Extract Past 3 Years CSR Spend trend or 3-year historical spend breakdown (e.g. 'FY24: ₹15.2 Cr, FY23: ₹12.8 Cr, FY22: ₹10.5 Cr' or 3-year average amount). Include years and amounts, or 'Not Found'",
  "education_csr_spend": "Extract CSR Spend specifically on Education / School projects for previous year (e.g. '₹6.50 Cr (FY24)' or '42% of total CSR spend'). Include amount, percentage and year if available, or 'Not Found'",
